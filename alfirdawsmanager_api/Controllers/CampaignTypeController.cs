...
namespace alfirdawsmanager_api.Controllers
{
    ...
    public class CampaignTypeController : Controller
    {
        ...
        /// </summary>
        /// <param name="catRequest">campaign type request object</param>
        ...
        public async Task<IActionResult> CreateCampaignType(CampaignTypeCreateRequest campaignTypeRequest)
        {
            try
            {
                ...
                {
                    return response = BadRequest(new { Success = result.Success, Message = !string.IsNullOrEmpty(result.Message) ? result.Message : "Something went wrong" });
                }
            }
            catch (Exception)
            {
        ...
        /// </summary>
        /// <param name="catRequest">Campaign type request opbject</param>
